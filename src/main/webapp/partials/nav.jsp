...
<nav class="navbar navbar-expand-md navbar-dark bg-danger mb-4">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<%--DIEGO 15-12 AGREGO LINK A PROMOCIONES --%>
			
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/turismo/offer/indexoffer.do">Promociones</a></li>
			</ul>
		...
		<c:if test="${user.isAdmin()}">
			...
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/turismo/users/indexusers.do">Usuarios ABM</a></li>
			</ul>
